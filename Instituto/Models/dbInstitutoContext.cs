...
//                optionsBuilder.UseSqlServer("server=gianeliasenati.database.windows.net; database=dbInstituto; User ID=gianeliasenati; Password=yanelaanco456+;");
//            }
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Bloque>(entity =>
            {
                entity.HasKey(e => e.IdBloque)
                    .HasName("PK__Bloques__6B0639437570B76B");
            ...
            modelBuilder.Entity<BloqueDetalle>(entity =>
            {
                ...
                entity.HasOne(d => d.IdBloqueNavigation)
                    ...
                    .HasConstraintName("FK__BloqueDet__ID_Bl__6754599E");

                entity.HasOne(d => d.IdCursoNavigation)
                    .WithMany()
                    .HasForeignKey(d => d.IdCurso)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__BloqueDet__ID_Cu__693CA210");

                entity.HasOne(d => d.IdProfesorNavigation)
                    .WithMany()
                    .HasForeignKey(d => d.IdProfesor)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__BloqueDet__ID_Pr__6A30C649");
            ...
            modelBuilder.Entity<Curso>(entity =>
            {
                entity.HasKey(e => e.IdCurso)
                    .HasName("PK__Cursos__DC72196F4EBFCBE3");
            ...
            modelBuilder.Entity<Estudiante>(entity =>
            {
                entity.HasKey(e => e.IdEstudiante)
                    .HasName("PK__Estudian__9B410A89862E9D31");
            ...
            modelBuilder.Entity<Matricula>(entity =>
            {
                entity.HasKey(e => e.IdMatricula)
                    .HasName("PK__Matricul__230086D73470A1C2");
                ...
                entity.HasOne(d => d.IdBloqueNavigation)
                    ...
                    .HasForeignKey(d => d.IdBloque)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Matricula__ID_Bl__6E01572D");

                entity.HasOne(d => d.IdEstudianteNavigation)
                    .WithMany(p => p.Matriculas)
                    .HasForeignKey(d => d.IdEstudiante)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Matricula__ID_Es__6D0D32F4");
            });

            modelBuilder.Entity<Profesore>(entity =>
            {
                entity.HasKey(e => e.IdProfesor)
                    .HasName("PK__Profesor__4D3751F648FFA0E1");
            ...
            modelBuilder.Entity<Programa>(entity =>
            {
                entity.HasKey(e => e.IdPrograma)
                    .HasName("PK__Programa__9DB8D163B800976C");
